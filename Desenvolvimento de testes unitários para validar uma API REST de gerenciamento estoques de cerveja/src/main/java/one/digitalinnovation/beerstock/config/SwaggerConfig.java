...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Alex Rogério";
    private static final String CONTACT_GITHUB = "https://gtihub.com/alexrogeriodj";
    private static final String CONTACT_EMAIL = "alexrogeriodj@gmail.com";
